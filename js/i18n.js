...
const I18N = {
  es: {
    ...
    common: {
      ...
      masDestinos: '+{n} más', yMasDestinos: 'y {n} más'
    },
    home: {
      ...
      compareRow1: ['Comparar embarcaciones', 'Web a web, WhatsApp a WhatsApp', 'Todos los barcos, una misma ficha comparable'],
  ...
  en: {
    ...
    common: {
      ...
      masDestinos: '+{n} more', yMasDestinos: 'and {n} more'
    },
    home: {
      ...
      compareRow1: ['Comparing boats', 'Site to site, WhatsApp to WhatsApp', 'Every boat, one comparable listing'],
